          ...
          <form onSubmit={handleEmailSubmit} style={{ marginBottom: isSignup ? 0 : 24 }}>
            {isSignup && (
              <Field label="name" icon={<Icon.user />} t={t}>
                <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="your name" required style={inputStyle(t)} />
              </Field>
            )}

            <Field label="email" icon={<Icon.mail />} t={t}>
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" required style={inputStyle(t)} />
            </Field>
          ...
          {!isSignup && (
            <>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
                ...
                <span style={{ fontSize: 10, color: t.textMutedMost }}>or</span>
                <div style={{ flex: 1, height: 1, background: t.border }} />
              </div>
